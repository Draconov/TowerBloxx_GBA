...
void TowerConstructionScene::_rebuild_hud(const TowerConstructionSnapshot& snapshot)
{
    ...
    const generated::UiCompositeAsset* const* target_badge_frames =
            _visual_theme == VisualTheme::Christmas ? generated::christmas_construction_target_badge_frames :
                                                     construction_target_badge_frames;
    const generated::UiCompositeAsset* const* white_digit_frames =
            _visual_theme == VisualTheme::Christmas ? generated::christmas_hud_white_digit_frames :
                                                     construction_white_digit_frames;
    ...
    const generated::UiCompositeAsset* const* state_indicator_frames =
            _visual_theme == VisualTheme::Christmas ? generated::christmas_hud_state_indicator_frames :
                                                     construction_state_indicator_frames;
    ...
    const generated::UiCompositeAsset& badge =
            ...
            *target_badge_frames[4] : *target_badge_frames[building_index];
